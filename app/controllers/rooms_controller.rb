class RoomsController < ApplicationController
  ...
  def room_params
    params.required(:room).permit(:home_type, :room_type, :accomodate, :bed_room, :bath_room, :listing_name, :summary, :address, :is_tv, :is_kitchen, :is_heating, :is_air, :is_internet, :price, :active)
  end
end
